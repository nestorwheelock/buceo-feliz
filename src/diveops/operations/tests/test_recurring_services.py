...
class TestSyncSeriesOccurrences:
    ...
    def weekly_series(self, dive_shop, excursion_type):
        ...
        from diveops.operations.models import ExcursionSeries, RecurrenceRule
    ...
    def test_sync_creates_excursions_in_window(self, weekly_series, user):
        ...
        from diveops.operations.services import sync_series_occurrences
    ...
    def test_sync_respects_cancelled_exception(self, weekly_series, user):
        ...
        from diveops.operations.services import sync_series_occurrences
        from diveops.operations.models import Excursion, RecurrenceException
    ...
    def test_sync_preserves_excursions_with_bookings(self, weekly_series, user):
        ...
        from diveops.operations.services import sync_series_occurrences
        from diveops.operations.models import Excursion, Booking, DiverProfile
...
class TestCancelOccurrence:
    ...
    def test_cancel_creates_exception(self, series_with_excursion, user):
        ...
        from diveops.operations.services import cancel_occurrence
        from diveops.operations.models import RecurrenceException
    ...
    def test_cancel_cancels_bookings(self, series_with_excursion, user):
        ...
        from diveops.operations.services import cancel_occurrence
        from diveops.operations.models import Booking, DiverProfile
        from django_parties.models import Person
...
class TestEditOccurrence:
    ...
    def series_with_excursions(self, dive_shop, user):
        ...
        from diveops.operations.models import ExcursionSeries, RecurrenceRule, ExcursionType
        from diveops.operations.services import sync_series_occurrences
    ...
    def test_edit_occurrence_sets_is_override(self, series_with_excursions, user):
        ...
        from diveops.operations.services import edit_occurrence
        from diveops.operations.models import Excursion
...
class TestEditSeries:
    ...
    def test_edit_series_updates_template(self, series_with_excursions, user):
        ...
        from diveops.operations.services import edit_series
    ...
    def test_edit_series_preserves_overrides(self, series_with_excursions, user):
        ...
        from diveops.operations.services import edit_series, edit_occurrence
        from diveops.operations.models import Excursion
...
class TestSplitSeries:
    ...
    def test_split_creates_new_series(self, series_with_excursions, user):
        ...
        from diveops.operations.services import split_series
        from diveops.operations.models import ExcursionSeries
