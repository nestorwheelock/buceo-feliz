...
class ChatFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                DiveOpsApp.getInstance().authRepository.registerFCMToken(
                    fcmToken = token,
                    deviceId = deviceId,
    ...
    private fun showNotification(
        ...
        // Build notification
        val notificationBuilder = NotificationCompat.Builder(this, DiveOpsApp.CHANNEL_ID)
